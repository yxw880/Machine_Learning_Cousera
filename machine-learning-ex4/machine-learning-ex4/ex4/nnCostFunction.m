...
a2 = [ones(size(a2,1),1) a2]; % add '+1' to a2 matrix

a3 = sigmoid(a2 * Theta2.');


yVec = zeros(m,num_labels); % vectorize y
...
reg = (lambda/(2*m))* (sum(sum(Theta1(:,2:end).^2))+sum(sum(Theta2(:,2:end).^2))); % add regulation
